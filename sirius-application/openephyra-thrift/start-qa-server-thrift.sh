...
export CLASSPATH=~/Downloads/thrift-0.9.2/lib/java/build/libthrift-0.9.2.jar:~/Downloads/thrift-0.9.2/lib/java/build/lib/slf4j-api-1.5.8.jar:~/Downloads/thrift-0.9.2/lib/java/build/lib/slf4j-log4j12-1.5.8.jar:~/Downloads/thrift-0.9.2/lib/java/build/lib/log4j-1.2.14.jar
...
export CLASSPATH=$CLASSPATH:~/Research/sirius/sirius-application/question-answer/openephyra-thrift:~/Research/sirius/sirius-application/question-answer/openephyra-thrift/gen-java

# Add command center to class path
export CLASSPATH=$CLASSPATH:~/Research/sirius/sirius-application/command-center/gen-java
